...
class Plav(object):
    ...
    def load_aircraft_config(self, modelparam):
    ...
    def load_atmosphere(self, modelparam, use_file_atmosphere:bool = True):
    ...
    def load_init_position(self, modelparam):
    ...
    def change_aircraft(self, sim_object: Simulator, modelparam, use_control_unit=True):
    ...
    def change_control(self, sim_object: Simulator, modelparam):
    ...
    def export_data(self, trimmed_sim_data):
