...
class Simulator(object):
    ...
    def __init__(self, init_state, time_span, aircraft, atmosphere, control_sys= None,t_step = 0.1):
        ...
        simulator.x_dot(self.time, self.state, aircraft, atmosphere, self.sim_log)
    ...
    def advance_timestep(self):
        ...
        self.time, self.state = basic_rk4(simulator.x_dot, self.time, self.t_step, self.state,\
        ...
        #get stuff
        simulator.x_dot(self.time, self.state, self.aircraft, self.atmosphere, self.sim_log)
        self.sim_log.save_line()
